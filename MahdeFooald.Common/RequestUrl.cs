...
namespace MahdeFooald.Common
{
    public static class RequestUrl
    {
        ...
        public static string BuildUrl(UrlBuilderMode mode, string userId, string tasksId)
        {
            ...
            return mode switch
            {
                ...
                UrlBuilderMode.SingleUser => $"{baseurl}systemusers?$select={_userSelectedItem}&$filter=domainname eq '{userId}'",
