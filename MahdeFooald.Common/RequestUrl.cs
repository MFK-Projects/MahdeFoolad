...
namespace MahdeFooald.Common
{
    public static class RequestUrl
    {
        ...
        private const string _taskSelectedItem = @"activityid,new_remained_time_hour,new_remaining_days,new_task_status,new_task_type,subject,prioritycode,description,new_telephone,_new_date_deadline_value,_ownerid_value,new_notification_threshold";
